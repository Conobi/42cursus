...
ShrubberyCreationForm::ShrubberyCreationForm(const ShrubberyCreationForm &val)
	...
	std::cout << MAG_FG << ITALIC << "ShrubberyCreationForm Copy constructor "
			  << RESET << ITALIC << "called" << RESET << std::endl;
	*this = val;
}

ShrubberyCreationForm::~ShrubberyCreationForm() {
	std::cout << YEL_FG << ITALIC << "ShrubberyCreationForm Destructor "
			  << RESET << ITALIC << "called" << RESET << std::endl;
}

ShrubberyCreationForm &ShrubberyCreationForm::operator=(
	const ShrubberyCreationForm &rhs) {
	std::cout << MAG_FG << ITALIC << "ShrubberyCreationForm Copy assignment "
...
static bool write_file(const std::string filename, const std::string content) {
	...
	std::cerr << RED_FG << "An error occured while writing to `" << filename
			  << "`." << RESET << std::endl;
	return (false);
}
...
void ShrubberyCreationForm::_executor() const {
	write_file(this->getTarget() + "_shrubbery", ascii_trees());
}
