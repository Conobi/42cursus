...
/*   Updated: 2022/08/23 14:42:20 by conobi           ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */
...
/**
 * @brief This function create a very sad prompt for Minishell.
 * Please do not use if you are not happy in your life.
 *
...
{
	free(c->prompt);
	c->prompt = ft_aconcat(4, SHELL_NAME, " - ", path, " $> ");
}
