...
/*   Updated: 2023/01/03 15:23:18 by conobi           ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */
...
Bureaucrat::~Bureaucrat() {
	...
	<< "Bureaucrat Destructor " << RESET
	<< ITALIC << "called" << RESET << std::endl;
}

Bureaucrat &Bureaucrat::operator=(const Bureaucrat &rhs) {
	std::cout << MAG_FG << ITALIC
	<< "Bureaucrat Copy assignment " << RESET
...
{
	std::cout << BLU_FG << ITALIC
		<< "Bureaucrat Assignement constructor " << RESET
