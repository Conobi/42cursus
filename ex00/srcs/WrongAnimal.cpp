...
/*   Updated: 2022/12/22 02:09:05 by conobi           ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */
...
WrongAnimal::WrongAnimal() {
	std::cout << BLU_FG << ITALIC
		<< "WrongAnimal Default constructor " << RESET
...
WrongAnimal::WrongAnimal(const WrongAnimal &val) {
	std::cout << MAG_FG << ITALIC
		<< "WrongAnimal Copy constructor " << RESET
		<< ITALIC << "called" << RESET << std::endl;
	*this = val;
}
...
WrongAnimal::~WrongAnimal() {
	...
	<< "WrongAnimal Destructor " << RESET
	<< ITALIC << "called" << RESET << std::endl;
}

WrongAnimal &WrongAnimal::operator=(const WrongAnimal &rhs) {
	std::cout << MAG_FG << ITALIC
	<< "WrongAnimal Copy assignment " << RESET
